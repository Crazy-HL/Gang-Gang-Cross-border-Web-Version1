...
class User(Base):
    ...
    wechat_unionid: Mapped[str] = mapped_column(String(128), default='', index=True)
    wechat_mini_openid: Mapped[str] = mapped_column(String(128), default='', index=True)
    wechat_web_openid: Mapped[str] = mapped_column(String(128), default='', index=True)
